                        ...
                        <View style={styles.containerCompanyDetails}>
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
                                    <Text style={styles.textLabel}>ID Registration&nbsp;:&nbsp;</Text>
                                </View>
                            ...
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
                                    <Text style={styles.textLabel}>Company Address&nbsp;:&nbsp;</Text>
                                </View>
                                <View style={styles.input}>
                            ...
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
                                    <Text style={styles.textLabel}>Company Phone&nbsp;:&nbsp;</Text>
                                </View>
                                <View style={styles.input}>
                            ...
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
                                    <Text style={styles.textLabel}>Company Fax&nbsp;:&nbsp;</Text>
                                </View>
                                <View style={styles.input}>
                            ...
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
                                    <Text style={styles.textLabel}>Contact Person&nbsp;:&nbsp;</Text>
                                </View>
                                <View style={styles.input}>
                                    <Text style={styles.textLabel}>{contact_person_namePdf}</Text>
                                </View>
                            </View>
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
                                ...
                                <View style={styles.input}>
                                    <Text style={styles.textLabel}>{contact_person_titlePdf}</Text>
                                </View>
                            </View>
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
                                ...
                                <View style={styles.input}>
                                    <Text style={styles.textLabel}>{contact_person_emailPdf}</Text>
                                </View>
                            </View>
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
                                ...
                                <View style={styles.input}>
                                    <Text style={styles.textLabel}>{contact_person_phonePdf}</Text>
                                </View>
                            </View>
                            <View style={styles.formGroup}>
                                <View style={styles.label}>
